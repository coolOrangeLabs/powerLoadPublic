#### Sample for loading files from a file system with powerLoad  ####
...
$VaultDB = "Vault-Target"                                       #Target server name
...
Invoke-PowerLoadSql -Statement "UPDATE Files SET ImportProperties = 1 where FileExtension in ('dwg', 'idw') and ContentSource = 'Inventor'"
